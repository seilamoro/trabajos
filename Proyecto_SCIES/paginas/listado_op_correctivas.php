...
$conf['general']['nombre_pagina'] = 'listado_op_correctivas.php';
...
$conf['database']['nombre_tabla'] = 'operacion_correctiva';
$conf['database']['clave_tabla'][0] = 'Id_operacion_corr';
...
$conf['database']['campos_sql'][0]['nombre_db'] = 'Descripcion';
...
$conf['texto']['titulo_tabla'] = 'Listado de Operaciones Correctivas';
...
if ( ($_GET['confirmar_modificar'] != '') && ($_GET['mintext_Descripcion'] != '') ) {
...
?>
				...
				<th class="titulo" id="borde_db" width='80%'>
					<div class="borde"></div>
					<div class="centro">
<?PHP		
