...
//$conf['database']['campos_sql_aux'][1]['nombre_mostrar_aux'] = 'Código Operación Preventiva';
...
<!-- EN ESTA PARTE ES DONDE SE LLEVA A CABO LA INSERCIÓN DE DATOS EN EL SELECT QUE PERMITE AÑADIR UNA NUEVA OPERACIÓN PREVENTIVA AL SUBCOMPONENTE QUE SE HA ELEGIDO-->
...
<!--FIN DEL LA INSERCIÓN DE DATOS EN EL SELECT DE NUEVA OPERACIÓN PREVENTIVA -->
