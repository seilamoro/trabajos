...
<HEAD>
	<title>Criterios de listado</title>
	<LINK rel="stylesheet" href="../css/comun.css">
	<script>
		//INICIO Carga el tipo de listado segun la periocidad
			function cargar_parametros(valor){
				location.href='?pag=criterio_listados.php&instalacion='+valor;
			}

			function semana(valor,valor2){
				location.href='?pag=criterio_listados.php&seman='+valor2+'&indic='+valor;
			}
			function mes(valor){
				location.href='?pag=criterio_listados.php&mess='+valor;
			}
			function ayo(valor){
				location.href='?pag=criterio_listados.php&anyio='+valor;
			}
		...
		//INICIO Carga los parametros dependiendo del centro
			...
			function cargar_listado(valor,fbox,tbox){
				...
				location.href='?pag=criterio_listados.php&listad='+valor+dir+dir2+'&ndis='+fbox.options.length+'&nsel='+tbox.options.length;
			}
			...
			function listar_personalizado(fbox,tbox,dia_ini,mes_ini,ayo_ini,dia_fin,mes_fin,ayo_fin,hora_ini,minuto_ini,hora_fin,minuto_fin){
				...
				location.href='?pag=listado_registros.php' + dir + dir2 + '&ndis=' + fbox.options.length + '&nsel=' + tbox.options.length + '&dia_i=' + dia_ini + '&mes_i=' + mes_ini + '&anio_i=' + ayo_ini + '&dia_f=' + dia_fin + '&mes_f=' + mes_fin + '&anio_f=' + ayo_fin + '&hora_i=' + hora_ini + '&minuto_i=' + minuto_ini + '&hora_f=' + hora_fin + '&minuto_f=' + minuto_fin;
			}
			...
			function listar_diario(fbox,tbox,dia_ini,mes_ini,ayo_ini){
				...
				location.href='?pag=listado_registros.php' + dir + dir2 + '&ndis=' + fbox.options.length + '&nsel=' + tbox.options.length + '&dia_i=' + dia_ini + '&mes_i=' + mes_ini + '&anio_i=' + ayo_ini;
			}
			...
			function listar_semanal(fbox,tbox,semana,mes_ini,ayo_ini){
				...
				location.href='?pag=listado_registros.php' + dir + dir2 + '&ndis=' + fbox.options.length + '&nsel=' + tbox.options.length + '&seman=' + semana + '&mes_i=' + mes_ini + '&anio_i=' + ayo_ini;
			}
			...
			function listar_mensual(fbox,tbox,mes_ini,ayo_ini){
				...
				location.href='?pag=listado_registros.php' + dir + dir2 + '&ndis=' + fbox.options.length + '&nsel=' + tbox.options.length + '&mes_i=' + mes_ini + '&anio_i=' + ayo_ini;
			}
			...
			function listar_anual(fbox,tbox,ayo_ini){
				...
				location.href='?pag=listado_registros.php' + dir + dir2 + '&ndis=' + fbox.options.length + '&nsel=' + tbox.options.length + '&anio_i=' + ayo_ini;
			}
	...
	for($i=0;$i<$nume_parametros;$i++){
		...
		for($f=0;$f<$nume_parametros;$f++){
			...
			if($parametros['Id_Parametro']==$_SESSION['disp'][$f]){
				...
				echo $_SESSION['disp'][$f].'-'.$_SESSION['disp']['pa'][$f].' <br>';
			}
		}
		for($f=0;$f<$nume_parametros;$f++){
			//echo $dis.''.$i."<br>";
			...
			if($parametros['Id_Parametro']==$_SESSION['sele'][$f]){
				...
				echo $_SESSION['sele'][$f].'-'.$_SESSION['sele']['pa'][$f].' <br>';
			}
		}
	}
}
...
<BODY style="background-color:transparent;">
	<center>
		...
		<br>
	<form name='datos'>
		<table class="listado" cellpadding="0" cellspacing="3" width="90%" align="center" background="../imagenes/fondos/fondotabla_comp1.gif">
			<tr>
				<td class='encabezado' colspan=2>Criterios
				</td>
			</tr>
			<tr>
				<td width='200px'>
					<table width="100%">
						<tr>
							<td class="titulo2" style="text-align:left;">Tipo de listado
								<table class="titulo2" width="100%">
									<tr>
										<td>
											<table width="100%">
											...
											<table class="titulo2" width="100%">
												<tr>
													<td>
														...
														<SELECT name='centro' align="absmiddle"		onchange=cargar_parametros(this.form.centro.value);alert(this.form.centro.value);>
															<OPTION></option>
																<?php
														...
														<td>
															<table class="titulo2" width="100%">
																<tr>
																	<td style="border:none;">
																		Disponibles
																		<select name="list1" size="5" style="width:158px;">
																			<?php
																	...
																	<td align='center' style="border:none;">
																		<br>
																		<input type="button" value="  >>  " onclick="moveall(this.form.list1,this.form.list2)" name="B1">
																		<br>
																		...
																		<br>
																		<input type="button" value="  <<  " onclick="moveall(this.form.list2,this.form.list1)" name="B2">
																	</td>
																	<TD style="border:none;">
																		Seleccionados
					...
					<table width='100%'>
						...
						<tr>
							<td colspan="4" align="center">
								<?php 
									if($_SESSION['listado']=="personalizado" || !isset($_SESSION['listado'])){
										echo '<INPUT TYPE="button" NAME="Búsqueda" VALUE="Búsqueda" onclick="listar_personalizado(this.form.list1, this.form.list2, this.form.dia_inicio_v.value, this.form.mes_inicio_v.value, this.form.anio_inicio_v.value, this.form.dia_fin_v.value, this.form.mes_fin_v.value, this.form.anio_fin_v.value, this.form.hora_inicio_v.value, this.form.minuto_inicio_v.value, this.form.hora_fin_v.value, this.form.minuto_fin_v.value);";>';
									}
									if($_SESSION['listado']=="diario"){
										echo '<INPUT TYPE="button" NAME="Búsqueda" VALUE="Búsqueda" onclick="listar_diario(this.form.list1, this.form.list2, this.form.dia_inicio_v.value, this.form.mes_inicio_v.value, this.form.anio_inicio_v.value);";>';
									}
								
									if($_SESSION['listado']=="semanal"){
										echo '<INPUT TYPE="button" NAME="Búsqueda" VALUE="Búsqueda" onclick="listar_semanal(this.form.list1, this.form.list2, this.form.semana_v.value, this.form.mes_inicio_v.value, this.form.anio_inicio_v.value);";>';
									}
								
									if($_SESSION['listado']=="mensual"){
										echo '<INPUT TYPE="button" NAME="Búsqueda" VALUE="Búsqueda" onclick="listar_mensual(this.form.list1, this.form.list2, this.form.mes_inicio_v.value, this.form.anio_inicio_v.value);";>';
									}
				
									if($_SESSION['listado']=="anual"){
										echo '<INPUT TYPE="button" NAME="Búsqueda" VALUE="Búsqueda" onclick="listar_anual(this.form.list1, this.form.list2, this.form.anio_inicio_v.value);";>';
									}
								?>
