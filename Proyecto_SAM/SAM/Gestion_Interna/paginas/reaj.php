<?if(isset($_SESSION['permisoREAJ']) && ($_SESSION['permisoREAJ']==true)) //Comprobando que se tiene permiso para acceder a la pagina
	...
	function llamar()
            	{
            	   var i
            	   if(document.imprimir.seleccionar[1].checked == false && document.imprimir.seleccionar[0].checked ==false){
						alert("Debe seleccionar una opción a realizar.");
						return false;
					} else {
            	  
    			for (i=0;i<document.imprimir.seleccionar.length;i++){ 
       			if (document.imprimir.seleccionar[i].checked) 
          			break; 
   				 } 
    		

            	  //alert(document.imprimir.seleccionar[i].value );
            	 
            	  if (document.imprimir.seleccionar[i].value =="i")
            	  	{
					window.open( "paginas/imprimir_reaj.php?anio=2007");
						} 
						
					if(document.imprimir.seleccionar[i].value =="e")
				     {
							var anio = document.imprimir.anio[document.imprimir.anio.selectedIndex].value; 
            	  	alert("Se borrarán todos los carnets vendidos en el año "+anio);
					window.location.href='.?pag=reaj.php&accion=venta&anio='+anio;
					}
...
<BODY onLoad="foco();">
    ...
    <div id="izquierda" style='float:left;margin-left:0px;padding-left:14px;padding-right:px;'>
			       ...
			       <td cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
                      ...
                      <table border="0" class="tabla_detalles" style="border: 1px solid #3F7BCC;" height="100" width="400" cellspacing="0" cellpadding="0" >
                        ...
                        <tr>
                           <td>&nbsp;</td>
                           <td  align="right" >
			                  <br><input type='radio' name='seleccionar' value="i">&nbsp;&nbsp;<label class="label_formulario">Imprimir</label></td>
                                 
                           <td align="left">
                               <br><input type='radio' name='seleccionar' value="e">&nbsp;&nbsp;<label class="label_formulario">Eliminar</label>
      ...
      if(($accion=='modificar')or($_GET['modificar']=='si')){print($block);}else{print($none);}?>>
            ...
            <thead>
             ...
             <tr>
                 <td cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
                    <table class="tabla_detalles" style="border: 1px solid #3F7BCC;" border="0" width="400" height="586" cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
      ...
      if(($accion=='eliminar')||($_GET['eliminar']=='si')){print($block);}else{print($none);}?>>
            ...
            <tr>
               <td cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
                   <table border="0" class="tabla_detalles" style="border: 1px solid #3F7BCC;" width="400" height="586">
 ...
 ?>
             <table border="0"  cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
                    ...
                    <tr>
                        <td cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 0px;">
                           <div id="tableContainer" class="tableContainer" style='height:585px;width: 747px;background-color:#f4fcff'>
