 ...
 <tr>
	...
	<td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center">
	  <tr>
		<td width="34%"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
			<td  align="center" bgcolor="#C40056" ><img src="../imagenes/albergue/foto10.jpg" width="147" height="96"></td>
		  </tr>
		  <tr>
		...
		<td width="34%"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
				<td align="center" bgcolor="#C24A87"><img src="../imagenes/albergue/foto11.jpg" width="147" height="96"></td>
		  </tr>
		  <tr>
				<td align="center"> <font face="Arial, Helvetica, sans-serif"> 
				  Sala Reuniones<BR>
		...
		<td width="33%"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
				<td align="center" bgcolor="#C40056"><img src="../imagenes/albergue/foto12.jpg" width="147" height="96"></td>
		  </tr>
		  <tr>
				<td align="center"> <font face="Arial, Helvetica, sans-serif"> 
				  Salón de Actos <BR>
	  ...
	  <tr>
		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td align="center" bgcolor="F79239" cellpadding="0" cellspacing="0">&nbsp;</td>
                                </tr>
                              </table></td>
		<td>
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
				<td align="center" bgcolor="F9AF6D" cellpadding="0" cellspacing="0"><font face="Arial, Helvetica, sans-serif">Habitaciones</font></td>
		  </tr>
	  ...
	  <tr>
		  <td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
			  <tr> 
				<td align="center" bgcolor="FFD046"><img src="../imagenes/albergue/foto14.jpg" width="147" height="96"></td>
			  </tr>
			  <tr> 
				<td align="center"><font face="Arial, Helvetica, sans-serif">Dobles</font><br> 
				  <br> </td>
			  </tr>
			</table></td>
		<td><table width="100%" height="100%" border="0"cellpadding="0" cellspacing="0">
		  <tr>
				<td align="center" bgcolor="FFDF7F"><img src="../imagenes/albergue/foto06.jpg" width="147" height="96"></td>
		  </tr>
		  <tr>
				<td align="center"><font face="Arial, Helvetica, sans-serif">Triples</font><br>
				  <br></td>
		  </tr>
		</table></td>
		<td><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>
				<td align="center" bgcolor="FFD046" cellpadding="0" cellspacing="0"><img src="../imagenes/albergue/foto13.jpg" width="147" height="96"></td>
		  </tr>
		  <tr>
				<td align="center"><font face="Arial, Helvetica, sans-serif">Compartidas&nbsp; 
				  </font><br>
				  <br></td>
		  </tr>
		</table></td>
	...
	<td width="598" align="center">
		<table width="250px">
		  ...
		  <td><a href="servicios_online.php"><img src="../imagenes/botones/anterior.gif" border="0"></a></td>
				<td><a href="otrosservicios_online.php"><img src="../imagenes/botones/siguiente.gif" border="0"></a></td>	
			</tr>
		</table>
		</td>
	<td>&nbsp;</td>
