	...
	<table WIDTH="100%" align="center" >
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img1.gif"></td>
                <td width="34%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Dirección:</b></td>
       ...
       <HR ALIGN="LEFT" COLOR="#C40056"></HR>
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img2.gif"></td>
                <td width="34%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Teléfonos:</b></td>
	  ...
	  <br>
            <table WIDTH="100%" align="center">
             <tr>
             <td> <font face="Arial, Helvetica, sans-serif">Miembro de la Red Española de Albergues Juveniles y de la “Hostelling International”.</font></td>
             </tr>
          </table>
            <table WIDTH="100%" align="center">
            ...
            <tr>
             <td rowspan=6 width="20%"></td>
                ...
                <td><font face="Arial, Helvetica, sans-serif">Precio según tarifas vigentes.</font></td>
            </tr>
            <tr>

                <td><img src="../imagenes/albergue/flecha.gif"></td>
                <td><font face="Arial, Helvetica, sans-serif">Abierto las 24 horas del día.</font></td>
            </tr>
            <tr>

                <td><img src="../imagenes/albergue/flecha.gif"></td>
                <td><font face="Arial, Helvetica, sans-serif">1 habitación doble, dotada de TV color y minibar.</font></td>
            </tr>
            <tr>
