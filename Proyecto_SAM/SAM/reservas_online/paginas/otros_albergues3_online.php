...
<table>
    ...
    <table border="0" width="100%" height="100%">
        <tr bgcolor="#C24A87">
            <td width="25%" height="25%" valign="top">
                <table width="100%" height="100%" border="0" bgcolor="#C64984">
                    <tr>
                        ...
                        <td class="letra"><b>Murias de Rechivaldo</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="letra">Ctra Santa Colomba</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  class="letra">987 69 11 50 </td>
            		</tr>
                    <tr>
            ...
            <td width="25%" valign="top"><table width="100%" height="100%" border="0" bgcolor="#C64984">
              <tr>
                <td class="letras_morado">Localidad:</td>
                <td class="letra"><b>Santa Catalina de Somoza</b></td>
              </tr>
              <tr>
                <td class="letras_morado">Nombre:</td>
          ...
          <td width="25%" height="25%" valign="top"><table width="100%" height="100%" border="0" bgcolor="#C64984">
            <tr>
              <td class="letras_morado">Localidad:</td>
              <td class="letra"><b>El Ganso</b></td>
            </tr>
            <tr>
              <td class="letras_morado">Nombre:</td>
              <td class="letra">Albergue de la Junta Vecinal </td>
            ...
            <tr>
              <td class="letras_morado">Direcci&oacute;n:</td>
              <td  class="letra">Las Eras(Antiguas Escuelas) </td>
            </tr>
            <tr>
              <td class="letras_morado">N&ordm; Plazas:</td>
              <td class="letra">16</td>
            </tr>
            <tr>
              <td class="letras_morado">Tel&eacute;fono:</td>
              <td class="letra">987 69 12 02</td>
            </tr>
            <tr>
              <td class="letras_morado">Apertura:</td>
              <td class="letra"> Todo el A&ntilde;o</td>
              ...
              <td colspan="3" >
                <table width="100%"  border="0" bgcolor="#FFAE6B">
                  <tr>
                    ...
                    <td  class="letra" style="text-align:left;"><b>Rabanal del Camino</b></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
              <td width="33%" height="128" valign="top">
                <table width="100%" height="100%" border="0" bgcolor="#FFAE6B">
                     <tr> 
                        <td class="letras_naranja">Nombre:</td>
                        <td  class="letra">Albergue Privado Ntra Sra del Pilar </td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">Direcci&oacute;n:</td>
                        <td  class="letra">Pza Jer&oacute;nimo Mor&aacute;n Alonso</td>
                     </tr>
                     <tr> 
                     ...
                     <tr> 
                        ...
                        <td  class="letra"> 987 69 18 90 </td>
                     </tr>
                     <tr> 
				   ...
				   <table width="100%" height="100%" border="0" bgcolor="#FFAE6B">
                     <tr> 
                        ...
                        <td  class="letra">Albergue Gaucelmo </td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">Direcci&oacute;n:</td>
                        <td  class="letra">Calvario 4 </td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">N&ordm; Plazas:</td>
                     ...
                     <tr> 
                        <td class="letras_naranja">Tel&eacute;fono:</td>
                        <td  class="letra">987 69 19 01 </td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">Apertura::</td>
    					...
    					<td width="33%" height="100%" valign="top"><table width="100%" height="100%" border="0" bgcolor="#FFAE6B">
                     <tr> 
                        <td class="letras_naranja">Nombre:</td>
                        <td  class="letra">Albergue Municipal</td>
                     </tr>
                     ...
                     <tr> 
                        <td class="letras_naranja">N&ordm; Plazas:</td>
                        <td  class="letra">40</td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">Tel&eacute;fono:</td>
                        <td  class="letra">987 69 12 75 <br> 630 57 37 94 </td>
                     </tr>
                     <tr> 
                        <td class="letras_naranja">Apertura:</td>
                        <td  class="letra">De Abril a Octubre. Cerrado del 13 al 17 de Agosto </td>
                     </tr>
                  </table>
				</td>
            </tr>
              ...
              <tr>
                <td colspan="3" >
                  <table width="100%"  border="0" bgcolor="#FFDF7B">
                    <tr>
                      <td class="letras_naranja" width="7%">Localidad:</td>
                      <td class="letra"><b>El Acebo</b></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td width="33%" height="128" valign="top">
                  <table width="100%" height="100%" border="0" bgcolor="#FFDF7B">
                    ...
                    <tr>
                      <td class="letras_naranja">N&ordm; Plazas:</td>
                      <td  class="letra">10</td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">Tel&eacute;fono:</td>
                      <td  class="letra"> 987 69 50 74 </td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">Apertura:</td>
                      <td  class="letra">Verano (Se Abre cuando es Necesario) </td>
                    </tr>
                </table></td>
                <td width="33%" valign="top">
                  <table width="100%" height="100%" border="0" bgcolor="#FFDF7B">
                    <tr>
                      <td class="letras_naranja">Nombre:</td>
                      <td  class="letra">Albergue Privado Mes&oacute;n el Acebo </td>
                   </tr>
                    <tr>
                      <td class="letras_naranja">Direcci&oacute;n:</td>
                      <td  class="letra">Real 16 </td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">N&ordm; Plazas:</td>
				...
				<table width="100%" height="100%" border="0" bgcolor="#FFDF7B">
                    <tr>
                      <td class="letras_naranja">Nombre:</td>
                      <td  class="letra">Albergue Privado Taberna de Jos&eacute;</td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">Direcci&oacute;n:</td>
                      <td  class="letra">Real 19 </td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">N&ordm; Plazas:</td>
                   <td  class="letra">14</td>
                    </tr>
                    <tr>
                      <td class="letras_naranja">Tel&eacute;fono:</td>
                      <td  class="letra">987 69 50 74 </td>
  ...
  <tr>
    ...
    <td align="center">
			...
			<tr>
				<td width="33%"><br><a href="otros_albergues2_online.php"><img src="../imagenes/botones/anterior.gif" border="0"></a></td>
				<td align="center"><br><a href="info_pere_online.php"><img src="../imagenes/botones/atras.gif" width="65" height="30" border="0"></a></td>
				<td align="right" width="33%"><br><a href="otros_albergues4_online.php"><img src="../imagenes/botones/siguiente.gif" border="0"></a></td>
			</tr>
		</table>
