          ...
          <td align="left" valign="top" width="200px" rowspan="2"> 
              ...
              <tr> 
                ...
                <td width="719" align="center" valign="middle"><u><!-- InstanceBeginEditable name="titulo" -->
					<b><font face="Arial, Helvetica, sans-serif" size="5" color="#C40056" >Albergue Peregrinos</font></b>
...
<table>
  <tr>
    ...
    <td valign="top"><table WIDTH="100%" align="center">
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img1.gif"></td>
                <td width="26%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Dirección:</b></td>
                <td width="70%" STYLE="font-family:Arial;color:black;"><?=$datos['Direccion_Alb']?> C.P. <?=$datos['CP_Alb']?></td>
            </tr>
       </table>
       ...
       <HR ALIGN="LEFT" COLOR="#C40056"></HR>
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img2.gif"></td>
                <td width="26%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Teléfonos:</b></td>
                <td width="70%" STYLE="font-family:Arial;color:black;"><?=$datos['Tfno1_Alb']?> <?
				if($datos['Tfno2_Alb']!="")
       ...
       <HR ALIGN="LEFT" COLOR="#C40056"></HR>
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img3.gif"></td>
                <td width="26%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Fax:</b></td>
                <td width="70%" STYLE="font-family:Arial;color:black;"><?=$datos['Fax_Alb']?>
   </td>
            </tr>
       </table>
       <table WIDTH="100%" align="center">
       <HR ALIGN="LEFT" COLOR="#C40056"></HR>
            <tr>
               <td width="4%"><img src="../imagenes/albergue/img4.gif"></td>
                <td width="26%" STYLE="font-family:Arial;color:#F79239;">&nbsp;&nbsp;<b>Plazas:</b></td>
                <td width="70%" STYLE="font-family:Arial;color:black;">64 (8 habitaciones para 8 personas)
   </td>
            </tr>
      </table>
		<table WIDTH="100%" align="center" STYLE="font-family:Arial;color:black;" valign="top">
            <tr>
             <td rowspan=3 width="30%"></td>
                <td width="4%"><img src="../imagenes/albergue/flecha.gif"></td>
                <td width="66%">Precio según tarifas vigentes.
</td>
            </tr>
            <tr>
                
                <td ><img src="../imagenes/albergue/flecha.gif"></td>
                <td >Acceso mediante credencial del peregrino.
</td>
            </tr>
	...
	<td>
		...
		<tr>
			<td valign="top"><a href="mapa_online.php"><img src="../imagenes/botones/mapa.gif" border="0"></a></td><td>&nbsp;</td>
			<td valign="top"><a href="turismo_online.php"><img src="../imagenes/botones/informacion_turistica.gif" border="0"></a></td><td>&nbsp;</td>
			<td valign="top"><a href="sanitaria_online.php"><img src="../imagenes/botones/informacion_sanitaria.gif"  border="0"></a></td><td>&nbsp;</td>
			<td valign="top"><a href="otros_albergues_online.php"><img src="../imagenes/botones/otros_albergues.gif"border="0"></a></td><td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr></table>
	</td>
	</tr>
