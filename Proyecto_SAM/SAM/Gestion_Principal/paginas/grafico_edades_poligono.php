...
// A partir de aqui se crean las sentencias que se van a usar para obtener la información necesaria para la gráfica
...
//Fin del título
	...
	$graph->img->SetMargin(80,80,30,40);
	...
	$graph->axis->title->SetFont(FF_FONT2,FS_NORMAL);
