...
//Fin del título
	...
	$datay = array($edad_0_9,$edad_10_19,$edad_20_25,$edad_26_29,$edad_30_39,$edad_40_49,$edad_50_59,$edad_60_69,$edad_70);
	...
	if ($datay == $datay2)
		...
		$graph->xaxis->title->SetFont(FF_FONT2,FS_BOLD, 10);
		...
		$graph->yaxis->title->SetFont(FF_FONT2,FS_BOLD, 10);
