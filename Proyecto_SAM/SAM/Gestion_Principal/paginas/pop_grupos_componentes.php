	...
	function llevar() {
		...
		for (i=0;i<document.getElementsByName('op').length;i++){
			if (document.getElementsByName('op')[i].checked == true)  {
				...
				window.opener.document.dar_alta.dni_componente.value = array_cadena[0];
				
				window.opener.document.dar_alta.tipo_doc_componente.value = array_cadena[1];
		...
		/*	window.opener.document.dar_alta.diaEx_componente.options[parseFloat(array_cadena[5])].selected = true;
                  window.opener.document.dar_alta.mesEx_componente.options[parseFloat(array_cadena[4])].selected = true;
				  for(j=0;j<window.opener.document.dar_alta.annoEx_componente.length;j++)	{
						if(window.opener.document.dar_alta.annoEx_componente.options[j].value == array_cadena[3])	{
							window.opener.document.dar_alta.annoEx_componente.options[j].selected = true;
							break;
						}
			...
			window.opener.document.dar_alta.diaNa_componente.options[parseFloat(array_cadena[8])].selected = true;
			  for(j=0;j<window.opener.document.dar_alta.annoNa_componente.length;j++)	{
						if(window.opener.document.dar_alta.annoNa_componente.options[j].value == array_cadena[6])	{
							window.opener.document.dar_alta.annoNa_componente.options[j].selected = true;
							break;
						}
						
					}
			//window.opener.document.dar_alta.annoNa_componente.options[array_cadena[6]-1900+1].selected = true;
				window.opener.document.dar_alta.mesNa_componente.options[parseFloat(array_cadena[7])].selected = true;*/
				window.opener.document.dar_alta.nombre_componente.value = array_cadena[9];
				
				window.opener.document.dar_alta.ape1_componente.value = array_cadena[10];
				window.opener.document.dar_alta.ape2_componente.value = array_cadena[11];
				
				if(array_cadena[12]=="F")
					window.opener.document.dar_alta.sexo[0].checked =true;
				else if(array_cadena[12]=="M")
					window.opener.document.dar_alta.sexo[1].checked =true;				
				window.close();
			}
		}
	}
...
<center>
<br><br><br>
<form name="formu" id="formu" action="pop_grupos_componentes.php" method="POST">
<input type="hidden" name="campo_actual" id="campo_actual" value="<? echo $_POST['campo_actual']; ?>">
	...
	$fecha_llegada = $_GET['anno']."-".$_GET['mes']."-".$_GET['dia'];
	...
	@ $db = mysql_pconnect($_SESSION['conexion']['host'],$_SESSION['conexion']['user'],$_SESSION['conexion']['pass']);
			...
			//$where = " WHERE  DNI LIKE '".$texto."%' and Nombre LIKE '".$texto_nombre."%'  and Apellido1 LIKE '".$texto_ape1."%' and Apellido2 LIKE '".$texto_ape2."%'";
