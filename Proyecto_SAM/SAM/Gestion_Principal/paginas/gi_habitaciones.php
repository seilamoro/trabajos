...
<!--------------------------------------------------------------------------------------------------------->			
											...
											<TR  style='padding:0px 0px 0px 0px;'>
												<TD style='padding:0px 0px 0px 0px;'>
													<TABLE cellspacing='0px' width='100%'>
														...
														<tr>
															<td colspan='2' height='50' align='center' class='label_formulario'>¿Está seguro de que desea eliminar la habitación?</td>
														</tr>
														<tr>
													...
													<TABLE width='100%' border='0' cellspacing='0px' style='border: 1px solid #3F7BCC;padding:0px 0px 0px 0px;'>
														<tr>
															<td>
																<table border='0' bgcolor='#F4FCFF'><tr>
																<td width='65'>&nbsp;</td>
																<td align='center' height='60' width='250'  class='label_formulario'>La Habitación " .$hab_anterior ." ya existe. Elija otro número de habitación</td></tr><tr><td width='30'>&nbsp;</td><td height='60'  valign='middle' align='center'><input type='image' src='../imagenes/botones-texto/aceptar.jpg' alt='Continuar' title='Continuar'></td></tr></table></form>
															</td>
														</tr>
													</table>
												</td>
	...
	else
	{
		...
		} //fin de se ha enviado el fromulario de nuevo tipo
	...
	<div style='width:520px;float:right;margin-right:40px;margin-top:50px;'>
		...
		/*
		Este es el tipo de consulta
		SELECT cambio_tipo_habitacion.Id_Tipo_Hab,consulta.Id_Hab,consulta.Fecha FROM cambio_tipo_habitacion INNER JOIN (SELECT Id_Hab, MAX(Fecha) as Fecha FROM cambio_tipo_habitacion WHERE Fecha <= curdate() GROUP BY Id_Hab) AS consulta ON cambio_tipo_habitacion.Fecha=consulta.Fecha AND cambio_tipo_habitacion.Id_Hab=consulta.Id_Hab;
		*/
