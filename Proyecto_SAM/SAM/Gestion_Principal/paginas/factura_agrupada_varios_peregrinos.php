...
<?PHP
    ...
    for ($i = 0; $i < COUNT($_POST['estancias_p']); $i++) {
		$estancia_agrupar = array();
		$estancia_agrupar = SPLIT('\*',$_POST['estancias_p'][$i]);
		$_SESSION['estancias_agrupar'][$i]['fila'] = MYSQL_FETCH_ARRAY(MYSQL_QUERY("SELECT * FROM pernocta_p LEFT JOIN cliente ON pernocta_p.DNI_Cl=cliente.DNI_Cl WHERE pernocta_p.DNI_Cl LIKE '".$estancia_agrupar[1]."' AND pernocta_p.Fecha_Llegada LIKE '".$estancia_agrupar[2]."';"));
	}
	...
	<tr id="titulo_tablas">
		<td align="left" style="padding:0px 0px 0px 0px;" width="100%">
			...
			<div class="champi_centro" style="width:<?PHP echo $_SESSION['gdh']['tamanios']['gdh_distribucion_ancho']; ?>;">
					Factura Agrupada de Peregrinos
			</div>
					...
					<td align="center">
						<table>
							<tr>
								...
								<td class="texto_detalles">		
									<img src="./../imagenes/botones-texto/facturar.jpg" class="imagen-boton" title="Crear Nueva Factura" value="Facturar" onclick="comprueba_dni('FAP');">
